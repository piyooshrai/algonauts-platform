...
('app_1', 'user_student_1', 'opp_1', 'I am excited to apply for the SDE Intern position at TechCorp. With my strong foundation in JavaScript and Python, I believe I can contribute effectively to your team.', 'SUBMITTED', '[{"status": "SUBMITTED", "timestamp": "2024-12-20T10:00:00Z"}]'::jsonb, 'DIRECT', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', NOW()),
('app_2', 'user_student_1', 'opp_3', 'As a passionate full-stack developer, I am thrilled about the opportunity to join StartupXYZ. The fast-paced environment aligns perfectly with my career goals.', 'SHORTLISTED', '[{"status": "SUBMITTED", "timestamp": "2024-12-18T10:00:00Z"}, {"status": "SHORTLISTED", "timestamp": "2024-12-22T14:00:00Z"}]'::jsonb, 'SEARCH', NOW() - INTERVAL '7 days', NOW() - INTERVAL '7 days', NOW()),

-- Priya's applications (she got placed at TechCorp)
('app_3', 'user_student_2', 'opp_2', 'With my strong background in data science and machine learning from BITS Pilani, I am confident I can add value to the Business Intelligence team at TechCorp.', 'OFFER_ACCEPTED', '[{"status": "SUBMITTED", "timestamp": "2024-11-15T10:00:00Z"}, {"status": "SHORTLISTED", "timestamp": "2024-11-20T14:00:00Z"}, {"status": "INTERVIEWED", "timestamp": "2024-11-25T10:00:00Z"}, {"status": "OFFER_MADE", "timestamp": "2024-11-28T10:00:00Z"}, {"status": "OFFER_ACCEPTED", "timestamp": "2024-11-30T10:00:00Z"}]'::jsonb, 'RECOMMENDATION', NOW() - INTERVAL '40 days', NOW() - INTERVAL '40 days', NOW()),

-- Amit's applications
('app_4', 'user_student_3', 'opp_5', 'I am applying for the Backend Developer position at GlobalSoft. My experience with Java and Spring Boot makes me a strong fit for this role.', 'UNDER_REVIEW', '[{"status": "SUBMITTED", "timestamp": "2024-12-22T10:00:00Z"}, {"status": "UNDER_REVIEW", "timestamp": "2024-12-24T10:00:00Z"}]'::jsonb, 'DIRECT', NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days', NOW()),
('app_5', 'user_student_3', 'opp_1', 'I would love to intern at TechCorp to gain experience in enterprise software development.', 'SUBMITTED', '[{"status": "SUBMITTED", "timestamp": "2024-12-23T10:00:00Z"}]'::jsonb, 'SEARCH', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', NOW()),

-- Sneha's applications
('app_6', 'user_student_4', 'opp_4', 'Frontend development is my passion. I have built multiple projects using React and Next.js, and I am excited about the opportunity at StartupXYZ.', 'INTERVIEW_SCHEDULED', '[{"status": "SUBMITTED", "timestamp": "2024-12-20T10:00:00Z"}, {"status": "SHORTLISTED", "timestamp": "2024-12-23T14:00:00Z"}, {"status": "INTERVIEW_SCHEDULED", "timestamp": "2024-12-25T10:00:00Z"}]'::jsonb, 'DIRECT', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', NOW()),
('app_7', 'user_student_4', 'opp_3', 'I am interested in the Full Stack Developer role as it would allow me to expand my backend skills while leveraging my frontend expertise.', 'SUBMITTED', '[{"status": "SUBMITTED", "timestamp": "2024-12-24T10:00:00Z"}]'::jsonb, 'SEARCH', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day', NOW()),

-- Vikram's applications (he got placed at GlobalSoft)
('app_8', 'user_student_5', 'opp_6', 'With my extensive experience in Kubernetes, Docker, and AWS, I am the ideal candidate for the DevOps Engineer position at GlobalSoft.', 'OFFER_ACCEPTED', '[{"status": "SUBMITTED", "timestamp": "2024-11-20T10:00:00Z"}, {"status": "SHORTLISTED", "timestamp": "2024-11-25T14:00:00Z"}, {"status": "INTERVIEWED", "timestamp": "2024-12-01T10:00:00Z"}, {"status": "OFFER_MADE", "timestamp": "2024-12-05T10:00:00Z"}, {"status": "OFFER_ACCEPTED", "timestamp": "2024-12-08T10:00:00Z"}]'::jsonb, 'DIRECT', NOW() - INTERVAL '35 days', NOW() - INTERVAL '35 days', NOW()),
('app_9', 'user_student_5', 'opp_3', 'I am interested in transitioning to full-stack development while leveraging my DevOps background.', 'REJECTED', '[{"status": "SUBMITTED", "timestamp": "2024-12-10T10:00:00Z"}, {"status": "REJECTED", "timestamp": "2024-12-15T14:00:00Z", "note": "Looking for candidates with more frontend experience"}]'::jsonb, 'SEARCH', NOW() - INTERVAL '15 days', NOW() - INTERVAL '15 days', NOW()),

-- Additional application
('app_10', 'user_student_1', 'opp_6', 'I am expanding my skills into DevOps and would love to learn from the experienced team at GlobalSoft.', 'SUBMITTED', '[{"status": "SUBMITTED", "timestamp": "2024-12-25T10:00:00Z"}]'::jsonb, 'RECOMMENDATION', NOW(), NOW(), NOW());
